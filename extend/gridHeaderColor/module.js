...
define(function() {
    return function() {
        const defalutColor = {"background": "#fcfcfc", "font": "#333333", "hover": "#efefef", "selectedBackground": "#efefef"},
            info = {
            "version": "1.0.0",
                        ...
                        },
                        {
                            ...
                            "OPTIONS": [
                                ...
                                },
                                {
                                    ...
                                    "element": "<div style='display: inline-flex; align-items: center; margin-right: 10px;'><span style='margin-right: 5px;'>글자:</span><input type='color'></div>"
                                },
                                {
                                    "key": "hover",
                                    "defalutValue": defalutColor["hover"],
                                    "element": "<div style='display: inline-flex; align-items: center; margin-right: 10px;'><span style='margin-right: 5px;'>오버:</span><input type='color'></div>"
                                },
                                {
                                    "key": "selectedBackground",
                                    "defalutValue": defalutColor["selectedBackground"],
                                    "element": "<div style='display: inline-flex; align-items: center; margin-right: 10px;'><span style='margin-right: 5px;'>선택배경:</span><input type='color'></div>"
                                }
                            ]
                        }
                    ]
            ...
            "method": {
                "setOptions": function(gridObj, os_data) {
                    let isAll = os_data["COLOR_HEADERS"] === "ALL",
                        ...
                        colorMap = {styles: {background: color["background"], foreground: color["font"], hoveredBackground:color["hover"], selectedBackground:color['selectedBackground']}},
                        gridGroupHeaderInfo = gridObj.groupIndexGroupHeaderMap || {};

                        $customWebData.tools.trimSplit(columns)
